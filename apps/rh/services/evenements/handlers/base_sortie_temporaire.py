...
Fichier : services/evenements/handlers/base_sortie_temporaire.py

Description :
    Classe de base des événements mettant
    temporairement fin à l'exercice des fonctions
    de l'agent.
...
class BaseSortieTemporaireHandler(
    BaseStatutHandler,
):
    """
    Classe de base des événements provoquant
